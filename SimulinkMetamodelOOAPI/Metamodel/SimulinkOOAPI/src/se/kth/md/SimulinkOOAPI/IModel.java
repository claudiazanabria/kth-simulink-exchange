 ...
 * <ul>
 *   <li>{@link se.kth.md.SimulinkOOAPI.IModel#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @see se.kth.md.SimulinkOOAPI.ISimulinkOOAPIPackage#getModel()
 * @model
 * @generated
 */
public interface IModel extends IProtoObject {
	/**
	 ...
	 * @see se.kth.md.SimulinkOOAPI.ISimulinkOOAPIPackage#getModel_Children()
	 * @model volatile="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link se.kth.md.SimulinkOOAPI.IModel#getChildren <em>Children</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

...
public class SimulinkSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimulinkPackage.PROTO_OBJECT: {
			...
			case SimulinkPackage.SYSTEM: {
				Simulink.System system = (Simulink.System)theEObject;
	 ...
	 * @generated
	 */
	public T caseSystem(Simulink.System object) {
		return null;
	}

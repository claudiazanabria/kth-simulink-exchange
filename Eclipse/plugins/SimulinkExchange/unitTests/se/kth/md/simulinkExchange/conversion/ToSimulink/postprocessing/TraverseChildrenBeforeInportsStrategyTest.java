...
@RunWith(JMock.class)
public class TraverseChildrenBeforeInportsStrategyTest {
	...
	public void allPartsAreVisitedTest() {
		...
		TraverseChildrenBeforeInportsStrategy.doIt(modelMock, delegateMock);
	}
	...
	public void systemVisitsItsChildrenTest() {
		...
		TraverseChildrenBeforeInportsStrategy.doIt(systemMock, delegateMock);
	}
	...
	public void systemReferenceVisitItsTargetTest() {
		...
		TraverseChildrenBeforeInportsStrategy.doIt(systemReferenceMock, delegateMock);
	}
	
	@Test
	public void childrenInportsOutportsLineSequenceTest() {
